...
function giveMe (results, callback) {
  ...
  // winston.log('info', '[USERNAME: %s] [TYPE: %s] [SEARCH: %s] [MESSAGE: %s]', options.username, options.type, options.search, results)
...
function setOptions (options, callback) {
  ...
  winston.log('info', '[USERNAME: %s] [TYPE: %s] [SEARCH: %s]', options.username, options.type, options.search)
